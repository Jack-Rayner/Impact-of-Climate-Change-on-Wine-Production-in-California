...
## Conclusion  
We identified some level of relationship between observed weather and wine yield per acre. From our model performance, it seems very possible to predict yield per acre based on these weather observations. Further improvements to our model could be done through a more extensive data set - incorporating either a more detailed or larger volume of data, either on a geographic or temporal scale. We could also incorporate additional information into our model to account for other potential factors, such as adaptive behavior, crop pests or disease, or soil composition.
